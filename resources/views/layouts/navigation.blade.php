            ...
            <div class="flex items-center">
                ...
                <div class="hidden space-x-6 pl-5  sm:flex">
                    ...
                    @if(Auth::user()->role === 'admin')
                        <a href="/buku"
                            class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->is('buku*') ? 'border-orange-500 text-white font-bold' : 'border-transparent text-gray-300 hover:text-white hover:border-gray-300' }} text-sm font-medium leading-5 transition duration-150 ease-in-out">
                            Data Buku
                        </a>
                        <a href="#"
